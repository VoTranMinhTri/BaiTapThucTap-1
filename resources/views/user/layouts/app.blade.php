...
<body class="bg">
    <div class="main">
        ...
        <div class="zalo-chat-widget" data-oaid="579745863508352884" data-welcome-message="Rất vui khi được hỗ trợ bạn!"
            data-autopopup="0" data-width="" data-height="" style="border: none; visibility: visible; bottom: 97px; right: 25px; position: fixed; width: 60px; height: 60px; z-index: 2147483644;"></div>
